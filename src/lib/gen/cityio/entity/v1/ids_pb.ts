...
/**
 * @generated from message cityio.entity.v1.ArmyOrderId
 */
export type ArmyOrderId = Message<"cityio.entity.v1.ArmyOrderId"> & {
  /**
   * @generated from field: string value = 1;
   */
  value: string;
...
/**
 * Describes the message cityio.entity.v1.ArmyOrderId.
 * Use `create(ArmyOrderIdSchema)` to create a new message.
 */
export const ArmyOrderIdSchema: GenMessage<ArmyOrderId> = /*@__PURE__*/
  messageDesc(file_cityio_entity_v1_ids, 4);

/**
 * @generated from message cityio.entity.v1.BattleId
 */
export type BattleId = Message<"cityio.entity.v1.BattleId"> & {
  /**
   * @generated from field: string value = 1;
   */
  value: string;
...
/**
 * Describes the message cityio.entity.v1.BattleId.
 * Use `create(BattleIdSchema)` to create a new message.
 */
export const BattleIdSchema: GenMessage<BattleId> = /*@__PURE__*/
...
export type EntityIdBag = Message<"cityio.entity.v1.EntityIdBag"> & {
  ...
  /**
   * @generated from field: repeated cityio.entity.v1.ArmyOrderId army_order_ids = 6;
   */
  armyOrderIds: ArmyOrderId[];
