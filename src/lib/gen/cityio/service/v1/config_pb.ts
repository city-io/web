...
export const file_cityio_service_v1_config: GenFile = /*@__PURE__*/
  fileDesc("", [file_cityio_entity_v1_common, file_google_protobuf_duration]);
...
export type PopulationPolicyConfig = Message<"cityio.service.v1.PopulationPolicyConfig"> & {
  ...
  /**
   * @generated from field: int32 default_garrison_percent = 2;
   */
  defaultGarrisonPercent: number;

  /**
   * @generated from field: int32 neutral_garrison_percent = 3;
   */
  neutralGarrisonPercent: number;

  /**
   * @generated from field: int32 max_garrison_percent = 4;
   */
  maxGarrisonPercent: number;
  ...
  /**
   * @generated from field: int32 min_garrison_percent = 9;
   */
  minGarrisonPercent: number;
};
