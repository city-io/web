...
<main class="bg-gray-50">
	<div class="mx-auto flex flex-col items-center justify-center px-6 py-8 md:h-screen lg:py-0">
		<p class="font-heavy mb-6 flex items-center text-3xl text-gray-900">
			Register for city.io
		</p>
			...
			<div class="space-y-4 p-6 sm:p-8 md:space-y-6">
				<form class="space-y-4 md:space-y-6" on:submit|preventDefault={handleRegister}>
					...
					<div>
						<label
							for="confirmPassword"
							class="mb-2 block text-sm font-medium text-gray-900">Confirm Password</label
						>
						<input
							class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-blue-600 focus:ring-blue-600 sm:text-sm"
							id="confirmPassword"
					...
					<p class="text-sm font-light">
						...
						<button class="font-medium text-blue-600" on:click={() => goto('/login')}>
							Sign in
						</button>
					</p>
				</form>
