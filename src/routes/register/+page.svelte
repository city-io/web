...
<main class="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0b1a0e] px-4 py-10">
  <!-- ambient background -->
  ...
  <div class="relative w-full max-w-sm">
    ...
    <div class="mb-8 flex flex-col items-center text-center">
      ...
      <p class="mt-1 text-sm text-gray-500">Create your account and found your first city.</p>
    </div>
